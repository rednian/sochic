  ...
  class Sell extends MY_Controller {
    ...
    public function load_packages($search = false) {
      ...
      foreach ($packages as $temp) {
        ...
        $item   = '<section class="media" style="cursor:pointer; width:32%; border:1px #ddd solid; display:inline-block; margin-right:1%; " 
   ...
   /*--------------------------------------*/
    ...
    public function load_services($service = FALSE) {
      ...
      foreach ($s->service_available($service) as $s) {
        ...
        $item   = '<section class="media" style="cursor:pointer; width:32%; border:1px #c77cb9 solid; display:inline-block; margin-right:1%; " 
