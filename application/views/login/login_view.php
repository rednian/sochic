        ...
        <div class="login login-with-news-feed">
            ...
            <div class="news-feed">
                <div class="news-image">
                    <img src="<?php echo base_url('assets/img/login-bg/bg-7.png'); ?>" data-id="login-cover-image" alt="" />
                </div>
            ...
            <div class="right-content">
                ...
                <div class="login-header">
                    <div class="brand">
                        <img src="<?php echo base_url('assets/img/sochic/sochic.png'); ?>" class="img-responsive">
                   ...
                   <?php echo validation_errors('<div class="alert alert-warning">', '</div>'); ?>
                    <form action="<?php echo base_url('verifylogin'); ?>" method="POST" class="margin-bottom-0">
                        ...
                        <div class="login-buttons">
                            <button type="submit" class="btn btn-danger btn-block btn-lg">Sign me in</button>
                        </div>
