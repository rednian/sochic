          ...
          <div>
            ...
            <ul class="nav nav-tabs" role="tablist">
              <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab"
                  data-toggle="tab">Products <span class="badge badge-danger" id="prod-count"></span></a></li>
              <li role="presentation"><a href="#service-tab" aria-controls="service-tab" role="tab"
                  data-toggle="tab">Services <span class="badge badge-danger" id="service-count"></span></a></li>
              <li role="presentation"><a href="#package" aria-controls="package" role="tab"
                  data-toggle="tab">Packages <span class="badge badge-danger" id="package-count"></span></a></li>
            </ul>
